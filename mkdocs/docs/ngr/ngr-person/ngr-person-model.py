...
# Generation date: 2026-05-18T09:10:57
# Schema: ngr-person
#
# id: https://data.norge.no/linkml/ngr-person
...
DEFAULT_ = CurieNamespace('', 'https://data.norge.no/linkml/ngr-person/')
...
class PersonContainer(YAMLRoot):
    ...
    class_class_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/linkml/ngr-person/PersonContainer")
    class_class_curie: ClassVar[str] = None
    class_name: ClassVar[str] = "PersonContainer"
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/linkml/ngr-person/PersonContainer")
...
class Person(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/linkml/ngr-person/Person")
...
class Personnavn(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/linkml/ngr-person/Personnavn")
...
class Folkeregisteridentifikator(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/linkml/ngr-person/Folkeregisteridentifikator")
...
class Foedselsnummer(Folkeregisteridentifikator):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/linkml/ngr-person/Foedselsnummer")
...
class DNummer(Folkeregisteridentifikator):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/linkml/ngr-person/DNummer")
...
class Personidentifikasjon(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/linkml/ngr-person/Personidentifikasjon")
...
class FalskIdentitet(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/linkml/ngr-person/FalskIdentitet")
...
class Identifikasjonsdokument(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/linkml/ngr-person/Identifikasjonsdokument")
...
class Identitetsgrunnlag(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/linkml/ngr-person/Identitetsgrunnlag")
...
class Kjoenn(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/linkml/ngr-person/Kjoenn")
...
class Sivilstand(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/linkml/ngr-person/Sivilstand")
...
class Personstatus(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/linkml/ngr-person/Personstatus")
...
class Statsborgerskap(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/linkml/ngr-person/Statsborgerskap")
...
class Opphold(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/linkml/ngr-person/Opphold")
...
class Foedsel(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/linkml/ngr-person/Foedsel")
...
class Dodsfall(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/linkml/ngr-person/Dodsfall")
...
class KontaktinformasjonDoedsbo(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/linkml/ngr-person/KontaktinformasjonDoedsbo")
...
class ForeldreansvarForelder(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/linkml/ngr-person/ForeldreansvarForelder")
...
class ForeldreansvarBarn(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/linkml/ngr-person/ForeldreansvarBarn")
...
class FamilierelasjonForelder(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/linkml/ngr-person/FamilierelasjonForelder")
...
class FamilierelasjonBarn(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/linkml/ngr-person/FamilierelasjonBarn")
...
class FamilierelasjonEktefelle(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/linkml/ngr-person/FamilierelasjonEktefelle")
...
class InnflyttingTilNorge(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/linkml/ngr-person/InnflyttingTilNorge")
...
class UtflyttingFraNorge(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/linkml/ngr-person/UtflyttingFraNorge")
...
class GeografiskAdresse(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/linkml/ngr-person/GeografiskAdresse")
...
class Bostedsadresse(GeografiskAdresse):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/linkml/ngr-person/Bostedsadresse")
...
class Postadresse(GeografiskAdresse):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/linkml/ngr-person/Postadresse")
...
class Oppholdsadresse(GeografiskAdresse):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/linkml/ngr-person/Oppholdsadresse")
...
class Adressebeskyttelse(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/linkml/ngr-person/Adressebeskyttelse")
...
class Verge(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/linkml/ngr-person/Verge")
...
class RettsligHandleevne(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/linkml/ngr-person/RettsligHandleevne")
...
class ReservasjonMotKommunikasjonPaaNett(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/linkml/ngr-person/ReservasjonMotKommunikasjonPaaNett")
...
class Kontaktopplysninger(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/linkml/ngr-person/Kontaktopplysninger")
...
class SpraakForElektroniskKommunikasjon(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/linkml/ngr-person/SpraakForElektroniskKommunikasjon")
