...
_Namn på arkivenhet eller kodeverk-element._





URI: [ark:naam](https://schema.fintlabs.no/arkiv/naam)
Alias: naam
...
| Slot URI | [ark:naam](https://schema.fintlabs.no/arkiv/naam) |
...
| ---  | ---  |
| self | ark:naam |
| native | https://schema.fintlabs.no/arkiv/:naam |
