...
# Slot: noyaktig_samsvar 


_Omgrep med nøyaktig same meining i anna vokabular (skos:exactMatch)._
...
| native | https://data.norge.no/linkml/skos-ap-no/noyaktig_samsvar |
