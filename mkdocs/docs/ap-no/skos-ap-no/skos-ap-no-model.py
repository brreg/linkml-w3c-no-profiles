...
DEFAULT_ = CurieNamespace('', 'https://data.norge.no/linkml/skos-ap-no/')
...
class LangString(str):
    ...
    type_model_uri = URIRef("https://data.norge.no/linkml/skos-ap-no/LangString")
...
class NonNegativeInteger(int):
    ...
    type_model_uri = URIRef("https://data.norge.no/linkml/skos-ap-no/NonNegativeInteger")
...
class Duration(str):
    ...
    type_name = "Duration"
    type_model_uri = URIRef("https://data.norge.no/linkml/skos-ap-no/Duration")
...
class GYear(str):
    ...
    type_name = "GYear"
    type_model_uri = URIRef("https://data.norge.no/linkml/skos-ap-no/GYear")
...
class Organisasjon(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/linkml/skos-ap-no/Organisasjon")
...
class VCardKontakt(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/linkml/skos-ap-no/VCardKontakt")
...
class Begrep(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/linkml/skos-ap-no/Begrep")
...
class Definisjon(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/linkml/skos-ap-no/Definisjon")
...
class AssosiativRelasjon(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/linkml/skos-ap-no/AssosiativRelasjon")
...
class GeneriskRelasjon(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/linkml/skos-ap-no/GeneriskRelasjon")
...
class PartitivRelasjon(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/linkml/skos-ap-no/PartitivRelasjon")
...
class Samling(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/linkml/skos-ap-no/Samling")
...
class Mediatype(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/linkml/skos-ap-no/Mediatype")
...
class Konsept(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/linkml/skos-ap-no/Konsept")
...
class Begrepssamling(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/linkml/skos-ap-no/Begrepssamling")
