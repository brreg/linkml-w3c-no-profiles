...
| native | https://data.norge.no/ngr/ngr-eiendom/Rettighetshaver |




## Examples
### Example: Rettighetshaver-rettighetshaver-1

```yaml
id: ngre:eksempel/rettighetshaver-1
er_av_type_person: ngre:eksempel/person-1
