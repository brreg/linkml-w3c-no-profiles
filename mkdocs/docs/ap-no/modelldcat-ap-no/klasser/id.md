...
URI: [https://data.norge.no/linkml/modelldcat-ap-no/id](https://data.norge.no/linkml/modelldcat-ap-no/id)
Alias: id
...
| [Modelkatalog](modelkatalog.md) | Ei kuratert samling av metadata om informasjonsmodellar (dcat:Catalog) |  no  |
...
| [Informasjonsmodell](informasjonsmodell.md) | Ein informasjonsmodell som er katalogisert i ein modelkatalog (modelldcatno:I... |  no  |
...
| Domain Of | [KatalogisertRessurs](katalogisertressurs.md), [Aktor](aktor.md), [Kontaktopplysning](kontaktopplysning.md), [Standard](standard.md), [Lisensdokument](lisensdokument.md), [Lokasjon](lokasjon.md), [Tidsperiode](tidsperiode.md), [Dokument](dokument.md), [Modelkatalog](modelkatalog.md), [Informasjonsmodell](informasjonsmodell.md), [Modellelement](modellelement.md), [Eigenskap](eigenskap.md), [Merknad](merknad.md), [Kodeelement](kodeelement.md), [Spraak](spraak.md), [Mediatype](mediatype.md), [Konsept](konsept.md), [Begrepssamling](begrepssamling.md) |
...
| ---  | ---  |
| self | https://data.norge.no/linkml/modelldcat-ap-no/id |
| native | https://data.norge.no/linkml/modelldcat-ap-no/id |
