...
DEFAULT_ = CurieNamespace('', 'https://data.norge.no/ap-no/xkos-ap-no/')
...
class Spraak(str):
    ...
    type_name = "Spraak"
    type_model_uri = URIRef("https://data.norge.no/ap-no/xkos-ap-no/Spraak")
...
class LangString(str):
    ...
    type_model_uri = URIRef("https://data.norge.no/ap-no/xkos-ap-no/LangString")
...
class NonNegativeInteger(int):
    ...
    type_model_uri = URIRef("https://data.norge.no/ap-no/xkos-ap-no/NonNegativeInteger")
...
class Duration(str):
    ...
    type_name = "Duration"
    type_model_uri = URIRef("https://data.norge.no/ap-no/xkos-ap-no/Duration")
...
class GYear(str):
    ...
    type_name = "GYear"
    type_model_uri = URIRef("https://data.norge.no/ap-no/xkos-ap-no/GYear")
...
class Klassifikasjon(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/ap-no/xkos-ap-no/Klassifikasjon")
...
class Klassifikasjonsnivaa(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/ap-no/xkos-ap-no/Klassifikasjonsnivaa")
...
class Kategori(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/ap-no/xkos-ap-no/Kategori")
...
class Klassifikasjonssamanlikning(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/ap-no/xkos-ap-no/Klassifikasjonssamanlikning")
...
class Kategorisamanlikning(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/ap-no/xkos-ap-no/Kategorisamanlikning")
...
class Organisasjon(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/ap-no/xkos-ap-no/Organisasjon")
...
class Tidsrom(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/ap-no/xkos-ap-no/Tidsrom")
...
class Mediatype(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/ap-no/xkos-ap-no/Mediatype")
...
class Konsept(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/ap-no/xkos-ap-no/Konsept")
...
class Begrepssamling(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/ap-no/xkos-ap-no/Begrepssamling")
