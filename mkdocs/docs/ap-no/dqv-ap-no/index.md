...
| Protobuf-skjema | [dqv-ap-no-schema.proto](dqv-ap-no-schema.proto) |
| ER-diagram (Mermaid) | [dqv-ap-no-erdiagram.md](dqv-ap-no-erdiagram.md) |
| PlantUML-diagram | [dqv-ap-no.svg](diagrams/dqv-ap-no.svg) · [dqv-ap-no.puml](diagrams/dqv-ap-no.puml) |
