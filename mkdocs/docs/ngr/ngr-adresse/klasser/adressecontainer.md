...
URI: [https://data.norge.no/ngr/ngr-adresse/AdresseContainer](https://data.norge.no/ngr/ngr-adresse/AdresseContainer)
...
| ---  | ---  |
| self | https://data.norge.no/ngr/ngr-adresse/AdresseContainer |
| native | https://data.norge.no/ngr/ngr-adresse/AdresseContainer |
