...
# Generation date: 2026-05-27T14:51:34
# Schema: ngr-virksomhet
#
# id: https://data.norge.no/ngr/ngr-virksomhet
...
DEFAULT_ = CurieNamespace('', 'https://data.norge.no/ngr/ngr-virksomhet/')
...
class VirksomhetContainer(YAMLRoot):
    ...
    class_class_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/ngr/ngr-virksomhet/VirksomhetContainer")
    class_class_curie: ClassVar[str] = None
    class_name: ClassVar[str] = "VirksomhetContainer"
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/ngr/ngr-virksomhet/VirksomhetContainer")
...
class Virksomhet(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/ngr/ngr-virksomhet/Virksomhet")
...
class Underenhet(Virksomhet):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/ngr/ngr-virksomhet/Underenhet")
...
class Hovedenhet(Virksomhet):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/ngr/ngr-virksomhet/Hovedenhet")
...
class Tilstand(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/ngr/ngr-virksomhet/Tilstand")
...
class Organisasjonsform(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/ngr/ngr-virksomhet/Organisasjonsform")
...
class Naeringskode(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/ngr/ngr-virksomhet/Naeringskode")
...
class Sektorkode(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/ngr/ngr-virksomhet/Sektorkode")
...
class Kontaktinformasjon(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/ngr/ngr-virksomhet/Kontaktinformasjon")
...
class Varslingsadresse(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/ngr/ngr-virksomhet/Varslingsadresse")
...
class Aktivitet(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/ngr/ngr-virksomhet/Aktivitet")
...
class RolleIVirksomhet(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/ngr/ngr-virksomhet/RolleIVirksomhet")
...
class Rolleinnehaver(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/ngr/ngr-virksomhet/Rolleinnehaver")
...
class Signaturrett(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/ngr/ngr-virksomhet/Signaturrett")
...
class Prokura(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/ngr/ngr-virksomhet/Prokura")
...
class GeografiskAdresse(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/ngr/ngr-virksomhet/GeografiskAdresse")
...
class Postadresse(GeografiskAdresse):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/ngr/ngr-virksomhet/Postadresse")
...
class Forretningsadresse(GeografiskAdresse):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/ngr/ngr-virksomhet/Forretningsadresse")
...
class Beliggenhetsadresse(GeografiskAdresse):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/ngr/ngr-virksomhet/Beliggenhetsadresse")
...
class Person(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/ngr/ngr-virksomhet/Person")
