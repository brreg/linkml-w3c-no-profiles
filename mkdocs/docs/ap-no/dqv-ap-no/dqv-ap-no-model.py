...
# Generation date: 2026-05-18T09:10:53
# Schema: dqv-ap-no
#
...
class Spraak(str):
    ...
    type_name = "Spraak"
    type_model_uri = URIRef("https://data.norge.no/linkml/dqv-ap-no/Spraak")
...
class KatalogisertRessurs(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/linkml/dqv-ap-no/KatalogisertRessurs")
...
class Aktor(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/linkml/dqv-ap-no/Aktor")
...
class Kontaktopplysning(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/linkml/dqv-ap-no/Kontaktopplysning")
...
class Tidsrom(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/linkml/dqv-ap-no/Tidsrom")
...
class RegulativRessurs(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/linkml/dqv-ap-no/RegulativRessurs")
...
class Identifikator(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/linkml/dqv-ap-no/Identifikator")
...
class Rettighetserklaring(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/linkml/dqv-ap-no/Rettighetserklaring")
...
class Sjekksum(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/linkml/dqv-ap-no/Sjekksum")
...
class Gebyr(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/linkml/dqv-ap-no/Gebyr")
...
class Relasjon(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/linkml/dqv-ap-no/Relasjon")
...
class Distribusjon(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/linkml/dqv-ap-no/Distribusjon")
...
class Datasettserie(KatalogisertRessurs):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/linkml/dqv-ap-no/Datasettserie")
...
class Datatjeneste(KatalogisertRessurs):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/linkml/dqv-ap-no/Datatjeneste")
...
class Katalogpost(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/linkml/dqv-ap-no/Katalogpost")
...
class Katalog(KatalogisertRessurs):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/linkml/dqv-ap-no/Katalog")
