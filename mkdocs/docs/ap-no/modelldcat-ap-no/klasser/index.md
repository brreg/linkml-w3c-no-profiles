...
| [Informasjonsmodell](informasjonsmodell.md) | Ein informasjonsmodell som er katalogisert i ein modellkatalog (modelldcatno:... |
...
| [Modellkatalog](modellkatalog.md) | Ei kuratert samling av metadata om informasjonsmodellar (dcat:Catalog) |
...
| [er_del_av_katalog](er_del_av_katalog.md) | Overordna modellkatalog (dct:isPartOf) |
...
| [modell](modell.md) | Informasjonsmodellar i modellkatalogen (modelldcatno:model) |
