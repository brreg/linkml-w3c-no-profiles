...
| ---  | --- | --- | --- |
| [Modellkatalog](modellkatalog.md) | [kontaktpunkt](kontaktpunkt.md) | range | [Kontaktopplysning](kontaktopplysning.md) |
...
| native | https://data.norge.no/ap-no/modelldcat-ap-no/Kontaktopplysning |
