...
# Slot: danner_symmetri_med 


_Eigenskap som denne eigenskapen dannar symmetri med (modelldcatno:formsSymmetryWith)._





URI: [modelldcatno:formsSymmetryWith](https://data.norge.no/vocabulary/modelldcatno#formsSymmetryWith)
...
| Slot URI | [modelldcatno:formsSymmetryWith](https://data.norge.no/vocabulary/modelldcatno#formsSymmetryWith) |
...
| ---  | ---  |
| self | modelldcatno:formsSymmetryWith |
| native | https://data.norge.no/linkml/modelldcat-ap-no/danner_symmetri_med |
