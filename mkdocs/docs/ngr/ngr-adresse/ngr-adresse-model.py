...
# Generation date: 2026-05-18T09:10:31
# Schema: ngr-adresse
#
# id: https://data.norge.no/linkml/ngr-adresse
...
DEFAULT_ = CurieNamespace('', 'https://data.norge.no/linkml/ngr-adresse/')
...
class AdresseContainer(YAMLRoot):
    ...
    class_class_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/linkml/ngr-adresse/AdresseContainer")
    class_class_curie: ClassVar[str] = None
    class_name: ClassVar[str] = "AdresseContainer"
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/linkml/ngr-adresse/AdresseContainer")
...
class GeografiskAdresse(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/linkml/ngr-adresse/GeografiskAdresse")
...
class OffisiellAdresse(GeografiskAdresse):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/linkml/ngr-adresse/OffisiellAdresse")
...
class Postboksadresse(GeografiskAdresse):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/linkml/ngr-adresse/Postboksadresse")
...
class Adressenavn(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/linkml/ngr-adresse/Adressenavn")
...
class Adresseomrade(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/linkml/ngr-adresse/Adresseomrade")
...
class Adressekode(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/linkml/ngr-adresse/Adressekode")
...
class Husnummer(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/linkml/ngr-adresse/Husnummer")
...
class Bruksenhetsnummer(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/linkml/ngr-adresse/Bruksenhetsnummer")
...
class Representasjonspunkt(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/linkml/ngr-adresse/Representasjonspunkt")
...
class GeografiskOmrade(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/linkml/ngr-adresse/GeografiskOmrade")
...
class Fylke(GeografiskOmrade):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/linkml/ngr-adresse/Fylke")
...
class Kommune(GeografiskOmrade):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/linkml/ngr-adresse/Kommune")
...
class Poststed(GeografiskOmrade):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/linkml/ngr-adresse/Poststed")
...
class Grunnkrets(GeografiskOmrade):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/linkml/ngr-adresse/Grunnkrets")
...
class Tettsted(GeografiskOmrade):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/linkml/ngr-adresse/Tettsted")
...
class Kirkesokn(GeografiskOmrade):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/linkml/ngr-adresse/Kirkesokn")
...
class Stemmekrets(GeografiskOmrade):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/linkml/ngr-adresse/Stemmekrets")
...
class KommunalKrets(GeografiskOmrade):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/linkml/ngr-adresse/KommunalKrets")
...
class Svalbard(GeografiskOmrade):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/linkml/ngr-adresse/Svalbard")
...
class Postboks(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/linkml/ngr-adresse/Postboks")
...
class Bygning(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/linkml/ngr-adresse/Bygning")
...
class Bruksenhet(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/linkml/ngr-adresse/Bruksenhet")
