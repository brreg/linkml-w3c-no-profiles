...
# Generation date: 2026-05-27T14:51:35
# Schema: skos-ap-no
#
# id: https://data.norge.no/ap-no/skos-ap-no
# description: Norsk applikasjonsprofil av SKOS for omgrep (begrep), modellert i LinkML med lenking framfor inlining. Basert på https://informasjonsforvaltning.github.io/skos-ap-no-begrep/
...
DEFAULT_ = CurieNamespace('', 'https://data.norge.no/ap-no/skos-ap-no/')
...
class Spraak(str):
    ...
    type_name = "Spraak"
    type_model_uri = URIRef("https://data.norge.no/ap-no/skos-ap-no/Spraak")
...
class LangString(str):
    ...
    type_model_uri = URIRef("https://data.norge.no/ap-no/skos-ap-no/LangString")
...
class NonNegativeInteger(int):
    ...
    type_model_uri = URIRef("https://data.norge.no/ap-no/skos-ap-no/NonNegativeInteger")
...
class Duration(str):
    ...
    type_name = "Duration"
    type_model_uri = URIRef("https://data.norge.no/ap-no/skos-ap-no/Duration")
...
class GYear(str):
    ...
    type_name = "GYear"
    type_model_uri = URIRef("https://data.norge.no/ap-no/skos-ap-no/GYear")
...
class Organisasjon(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/ap-no/skos-ap-no/Organisasjon")
...
class VCardKontakt(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/ap-no/skos-ap-no/VCardKontakt")
...
class Begrep(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/ap-no/skos-ap-no/Begrep")
...
class Definisjon(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/ap-no/skos-ap-no/Definisjon")
...
class AssosiativRelasjon(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/ap-no/skos-ap-no/AssosiativRelasjon")
...
class GeneriskRelasjon(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/ap-no/skos-ap-no/GeneriskRelasjon")
...
class PartitivRelasjon(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/ap-no/skos-ap-no/PartitivRelasjon")
...
class Samling(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/ap-no/skos-ap-no/Samling")
...
class Mediatype(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/ap-no/skos-ap-no/Mediatype")
...
class Konsept(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/ap-no/skos-ap-no/Konsept")
...
class Begrepssamling(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/ap-no/skos-ap-no/Begrepssamling")
