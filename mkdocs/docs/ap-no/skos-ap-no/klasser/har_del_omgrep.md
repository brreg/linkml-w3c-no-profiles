...
_Omgrep som er ein del av dette omgrepet (xkos:hasPart)._





URI: [xkos:hasPart](http://rdf-vocabulary.ddialliance.org/xkos#hasPart)
...
| ---  | ---  |
| self | xkos:hasPart |
| native | https://data.norge.no/ap-no/skos-ap-no/har_del_omgrep |
