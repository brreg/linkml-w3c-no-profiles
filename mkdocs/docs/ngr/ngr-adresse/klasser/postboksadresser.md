...
# Slot: postboksadresser 



URI: [https://data.norge.no/ngr/ngr-adresse/postboksadresser](https://data.norge.no/ngr/ngr-adresse/postboksadresser)
...
| Property | Value |
| --- | --- |
| Range | [Postboksadresse](postboksadresse.md) |
...
| ---  | ---  |
| self | https://data.norge.no/ngr/ngr-adresse/postboksadresser |
| native | https://data.norge.no/ngr/ngr-adresse/postboksadresser |
