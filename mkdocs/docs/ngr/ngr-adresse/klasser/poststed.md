...
| ---  | ---  |
| self | ngr:Poststed |
| native | https://data.norge.no/ngr/ngr-adresse/Poststed |




## Examples
### Example: Poststed-0101

```yaml
id: https://example.org/poststed/0101
namn: Oslo
postnummer: '0101'

```
### Example: Poststed-0150

```yaml
id: https://example.org/poststed/0150
namn: Oslo
postnummer: '0150'
