...
| [Basisgruppe](basisgruppe.md) | Skoleklasse som hovedsaklig samler elever i ulike fag |
| [Begrepssamling](begrepssamling.md) | Ei SKOS-omgrepssamling (temavokabular) |
| [Containerklasse](containerklasse.md) | Containerklasse for alle klasser som kan inngå i datasettet |
...
| [Person](person.md) | Eit menneske individ |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[Elev](elev.md) | En person som går på skole |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[Kontaktlaerer](kontaktlaerer.md) | En lærer med ansvar for ei basisgruppe og er skolens kontaktpunkt for elevane... |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[Rektor](rektor.md) | Høgaste akademiske leder av en skole |
...
| [Skole](skole.md) | En skole er en privat eller offentlig institusjon eller et lærested hvor lære... |
| [Skoleeier](skoleeier.md) | Superklasse for alle typer skoleeiere |
...
| [basisgrupper](basisgrupper.md) | Container slot for å legge tilrette for å kunne ha fleire instanser av basisg... |
...
| [elever](elever.md) | Container slot for å legge tilrette for å kunne ha fleire instanser av elev i... |
...
| [fylker](fylker.md) | Container slot for å legge tilrette for å kunne ha fleire instanser av fylke ... |
...
| [kommuner](kommuner.md) | Container slot for å legge tilrette for å kunne ha fleire instanser av kommun... |
| [komprimeringsformat](komprimeringsformat.md) | Komprimeringsformat brukt i distribusjonen |
| [kontaktlaerere](kontaktlaerere.md) | Container slot for å legge tilrette for å kunne ha fleire instanser av kontak... |
...
| [private_virksomheter](private_virksomheter.md) | Container slot for å legge tilrette for å kunne ha fleire instanser av privat... |
| [produsent](produsent.md) | Aktøren som primært har skapt ressursen |
| [referanse](referanse.md) | Referanse til ekstern ressurs |
| [rektorer](rektorer.md) | Container slot for å legge tilrette for å kunne ha fleire instanser av rektor... |
...
| [skoler](skoler.md) | Container slot for å legge tilrette for å kunne ha fleire instanser av skole ... |
