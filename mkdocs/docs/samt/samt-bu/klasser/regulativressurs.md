...
## Examples
### Example: RegulativRessurs-lov-2019-123

```yaml
id: samtbuskole:lov-2019-123
tittel:
- Lov om grunnskolen
beskrivelse:
- Lovverk som regulerer grunnskolen.
spraak:
- samtbuskole:no
type_concept: samtbuskole:Lov
har_referanse:
- https://lovdata.no/lov/2019-123
