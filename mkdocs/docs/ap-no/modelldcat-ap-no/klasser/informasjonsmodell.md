...
_Ein informasjonsmodell som er katalogisert i ein modellkatalog (modelldcatno:InformationModel)._
...
| native | https://data.norge.no/ap-no/modelldcat-ap-no/Informasjonsmodell |
