...
| ---  | --- | --- | --- |
| [Modellkatalog](modellkatalog.md) | [lisens](lisens.md) | range | [Lisensdokument](lisensdokument.md) |
...
| native | https://data.norge.no/ap-no/modelldcat-ap-no/Lisensdokument |
