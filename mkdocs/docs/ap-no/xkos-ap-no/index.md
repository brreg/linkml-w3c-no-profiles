...
| Protobuf-skjema | [xkos-ap-no-schema.proto](xkos-ap-no-schema.proto) |
| ER-diagram (Mermaid) | [xkos-ap-no-erdiagram.md](xkos-ap-no-erdiagram.md) |
| PlantUML-diagram | [xkos-ap-no.svg](diagrams/xkos-ap-no.svg) · [xkos-ap-no.puml](diagrams/xkos-ap-no.puml) |
